...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myButton.setTitle("シャープ", for: UIControl.State.normal)
    ...
    @objc func onClickMyButton(sender: UIButton){
        ...
        // フィルターを通した画像をアウトプット.
        let myOutputImage : CIImage = mySharpFilter!.outputImage!
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myButton.backgroundColor = UIColor.black
        myButton.layer.masksToBounds = true
        myButton.setTitle("シャープ", for: UIControlState.normal)
        myButton.titleLabel?.font = UIFont.systemFont(ofSize: UIFont.smallSystemFontSize)
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myButton.layer.masksToBounds = true
        myButton.setTitle("シャープ", forState: UIControlState.Normal)
